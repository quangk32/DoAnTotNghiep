...
if (!isset($_SESSION['user']['id'])) {
    echo "<script>alert('Vui lòng đăng nhập để cập nhật thông tin.'); window.location= '$baseUrl/pages/login.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<script>alert('Cập nhật thông tin thành công!'); window.location='$baseUrl/pages/inforuser.php';</script>";
    exit;
}
...
<div class="container" style="margin: 50px auto; max-width: 400px;">
    <form method="post" action="<?= $baseUrl ?>/pages/inforuser.php">
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="<?= $baseUrl ?>/pages/logout.php" class="btn btn-danger">Đăng xuất</a>
                </div>
            </div>
        </div>
    </form>
