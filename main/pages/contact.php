...
if (!empty($_POST)) {
	...
	$sql = "INSERT INTO FeedBack(user_id, fname, email, phone_number, address, subject_name, note, status, created_at, updated_at)
			VALUES('$user_id','$name', '$femail', '$phone_number', '$faddress', '$subject_name', '$note', 0, '$created_at', '$updated_at')";
	$db = new Database();
	...
	<form method="post">
		<div class="row">
			...
			<div class="form-group">
				...
				<a href="<?= $baseUrl ?>/pages/checkout.php"><button class="btn btn-success" onclick="handleContact()" style="border-radius: 0px; font-size: 26px; width: 100%;">GỬI PHẢN HỒI</button></a>
			</div>
			<div class="col-md-6">
