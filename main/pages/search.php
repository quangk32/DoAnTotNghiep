  ...
  <div class="container" style="margin-top: 20px; margin-bottom: 20px;">
      ...
      <?php
        foreach ($data as $pItem) {
          ...
          <a href="'.$baseUrl.'/pages/detail.php?id=' . $pItem['id'] . '">
            <img src="'.$baseUrl.'/'.$pItem['image']. '" style="width: 100%; height: 220px; object-fit: cover; border-radius: 6px;">
          </a>
          ...
          <div class="price-container">
            <p class="discount-price" style="color: red; font-weight: bold;">' . number_format($pItem['price'] * (100-$pItem['discount']) / 100) . ' VND </p> 
