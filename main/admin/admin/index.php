...
if (isset($_GET['search']) &&  $_GET['search'] != null) {
    $search = $_GET['search'];
    $sql = "SELECT admin.*,roles.name as role_name FROM admin,roles  WHERE admin.role_id=roles.id AND admin.deleted=0 AND admin.email like '%$search%' ORDER BY id ";
    
} else {
    $sql = "SELECT admin.*,roles.name as role_name FROM admin,roles  WHERE admin.role_id=roles.id AND admin.deleted=0 ORDER BY id  LIMIT $currentIndex, $page_number_max";
}
                            ...
                            foreach ($data as $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($item['id'] != $item['id'] && $item['role_id'] != 1) : ?>
