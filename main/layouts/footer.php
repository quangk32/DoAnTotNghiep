...
<footer class="bg-light text-dark pt-5 border-top w-100">
  <div class="container">
    <div class="row">

      <!-- Cột 1: Giới thiệu -->
      <div class="col-md-3 mb-4">
        <h5 class="text-danger fw-bold">Thời trang nam TORANO</h5>
        <p>Hệ thống thời trang cho phái mạnh hàng đầu Việt Nam, hướng tới phong cách nam tính, lịch lãm và trẻ trung. Thiết kế bởi Vũ Duy Quang.</p>
        <ul class="footerNav-social" style="display:flex;">											
            <li>
            ...
            <li>
                <a href="/" target="_blank" rel="noopener" title="Twitter" aria-label="Twitter">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 512 512"><g><g><g><path d="M512,97.248c-19.04,8.352-39.328,13.888-60.48,16.576c21.76-12.992,38.368-33.408,46.176-58.016 c-20.288,12.096-42.688,20.64-66.56,25.408C411.872,60.704,384.416,48,354.464,48c-58.112,0-104.896,47.168-104.896,104.992	c0,8.32,0.704,16.32,2.432,23.936c-87.264-4.256-164.48-46.08-216.352-109.792c-9.056,15.712-14.368,33.696-14.368,53.056 c0,36.352,18.72,68.576,46.624,87.232c-16.864-0.32-33.408-5.216-47.424-12.928c0,0.32,0,0.736,0,1.152	c0,51.008,36.384,93.376,84.096,103.136c-8.544,2.336-17.856,3.456-27.52,3.456c-6.72,0-13.504-0.384-19.872-1.792 c13.6,41.568,52.192,72.128,98.08,73.12c-35.712,27.936-81.056,44.768-130.144,44.768c-8.608,0-16.864-0.384-25.12-1.44 C46.496,446.88,101.6,464,161.024,464c193.152,0,298.752-160,298.752-298.688c0-4.64-0.16-9.12-0.384-13.568	C480.224,136.96,497.728,118.496,512,97.248z"></path></g></g></g></svg>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="https://www.youtube.com/@torano1287" target="_blank" rel="noopener" title="Youtube" aria-label="Youtube">
        ...
        <ul class="payment-icon" style="display: flex;">
										<li><img class=" lazyloaded" data-src="//theme.hstatic.net/200000690725/1001078549/14/payment_1_img.png?v=732" src="//theme.hstatic.net/200000690725/1001078549/14/payment_1_img.png?v=732" alt="Vnpay" title="Vnpay"></li>
										<li><img class=" lazyloaded" data-src="//theme.hstatic.net/200000690725/1001078549/14/payment_5_img.png?v=732" src="//theme.hstatic.net/200000690725/1001078549/14/payment_5_img.png?v=732" alt="Napas" title="Napas"></li>
										<li><img class=" lazyloaded" data-src="//theme.hstatic.net/200000690725/1001078549/14/payment_6_img.png?v=732" src="//theme.hstatic.net/200000690725/1001078549/14/payment_6_img.png?v=732" alt="Visa" title="Visa"></li>
									</ul>
      </div>

      <!-- Cột 2: Liên hệ -->
      <div class="col-md-3 mb-4">
        <h5 class="text-danger fw-bold">Thông tin liên hệ</h5>
        ...
        <p class="fw-semibold mt-3">Phương thức vận chuyển:</p>
        <ul class="shipment-icon" style="display:flex">
									<li><img class=" lazyloaded" data-src="//theme.hstatic.net/200000690725/1001078549/14/shipment_1_img.png?v=732" src="//theme.hstatic.net/200000690725/1001078549/14/shipment_1_img.png?v=732" alt="GHN" title="GHN"></li>
									<li><img class=" lazyloaded" data-src="//theme.hstatic.net/200000690725/1001078549/14/shipment_2_img.png?v=732" src="//theme.hstatic.net/200000690725/1001078549/14/shipment_2_img.png?v=732" alt="Ninjavan" title="Ninjavan"></li>
									<li><img class=" lazyloaded" data-src="//theme.hstatic.net/200000690725/1001078549/14/shipment_3_img.png?v=732" src="//theme.hstatic.net/200000690725/1001078549/14/shipment_3_img.png?v=732" alt="Ahamove" title="Ahamove"></li>
									<li><img class=" lazyloaded" data-src="//theme.hstatic.net/200000690725/1001078549/14/shipment_4_img.png?v=732" src="//theme.hstatic.net/200000690725/1001078549/14/shipment_4_img.png?v=732" alt="J&amp;T" title="J&amp;T"></li>
								</ul>
      </div>

      <!-- Cột 3: Nhóm liên kết -->
      <div class="col-md-3 mb-4">
        <h5 class="text-danger fw-bold">Nhóm liên kết</h5>
        <ul class="list-unstyled">
          <li><a href="#" class="text-decoration-none text-dark">Tìm kiếm</a></li>
      ...
      <div class="col-md-3 mb-4">
        <h5 class="text-danger fw-bold">Đăng ký nhận tin</h5>
        <p>Để cập nhật những sản phẩm mới, ưu đãi đặc biệt và thông tin giảm giá khác.</p>
        <form class="d-flex mb-3">
          <input type="email" class="form-control me-2" placeholder="Nhập email của bạn" />
          <button class="btn btn-danger">ĐĂNG KÝ</button>
        </form>
        <img class=" lazyloaded" data-src="//theme.hstatic.net/200000690725/1001078549/14/footer_logobct_img.png?v=732" src="//theme.hstatic.net/200000690725/1001078549/14/footer_logobct_img.png?v=732" alt="Bộ Công Thương">
      </div>
    </div>
  </div>
  <!-- back to top -->
